...
let volcadoImagen=document.querySelectorAll('#volcado-imagen #imagen-volcada');



let volcadofondos=document.getElementsByClassName('volcadofondos');
let volcado=document.getElementById('volcado');
//let volcadoImagen= document.querySelector('#volcado #volcado-imagen');       
...
let imagenSobre= document.querySelectorAll('.imagenSobre');
                            ...
                            function handleClick(event) {    //  SIN pooner la palabra  function adentro del objeto
                                        ...
                                        if (eseId=='aconejo') {         
                                                ...
                                                function creoImgConejo(){    
                                                   ...
                                                   // FUNCIONA ASÍ pero tendría que rpetir con cada uno ->  let laImgDragon=document.getElementById('laImgDragon').remove();                 
                                                };
                                                creoImgConejo();

                                        } else if (eseId=='adragon') {    
                                                ...
                                                function creoImgTigre(){
                                                    ...
                                                    let creoCajaTigre = document.createElement('div');//  CREO una IMAGEN
                                                    creoCajaTigre.id='cajaTigre';
                                                    creoCajaTigre.classList='cajas';
                                                    volcadoImagen.appendChild(creoCajaTigre);                                                    

                                                    creoCajaTigre.appendChild(creoImgTigre);  //  A SU PADRE le incluyo este hijo  
                                                };                                                
                                                creoImgTigre();                                           
                                                ...
                                                function creoImgBuey(){     
                                                    ...
                                                    let creoCajaBuey= document.createElement('div');//  CREO una IMAGEN
                                                    creoCajaBuey.id='cajaBuey';
                                                    creoCajaBuey.classList='cajas';
                                                    volcadoImagen.appendChild(creoCajaBuey);     

                                                    creoCajaBuey.appendChild(creoImgBuey);  //  A SU PADRE le incluyo este hijo  
                                                };
                                                creoImgBuey();
                                                let creoCajaBuey= document.createElement('div');//  CREO una IMAGEN
                                                if(volcadoImagen.appendChild!==creoCajaBuey ){
                                                    volcadoImagen.removeChild();
                                                }

                                        } else if (eseId=='aperro') { 
                                                function creoImgPerro(){
                                                    ...
                                                    //if (imagenSobre!==laImgPerro){ imagenSobre!==laImgPerr.remove()    }                       
                                                };
                                                creoImgPerro();

                                        } else if (eseId=='acerdo') { 
...
signosEnlaces.forEach(function(signosEnlace){
    ...
    signosEnlace.addEventListener('click',function(){   
                    ...
                    /* 
                        while (volcadoImagen.firstChild) {
                            volcadoImagen.removeChild(volcado.firstChild);
                        }

                        let imag=document.createElement("img");
                        imag.src=talCual.imagen;
                        volcadoImagen.appendChild(imag);  */

            let eslaFuncImagen=equivalencias(this.image);
